...
#스텟 공격력
test_statPAD1=LabelFrame(stat_PAD_note)
test_statPAD1.place(relx=0.01, relwidth=0.98, relheight=0.75)

test_statPAD2=LabelFrame(stat_PAD_note)
test_statPAD2.place(relx=0.01, rely=0.76,relwidth=0.98, relheight=0.99)
...
test_archiving3.place(relx=0.01, rely=0.36, relwidth=0.98, relheight=0.20)

test_archiving4=LabelFrame(archiving_note, text="영웅")
test_archiving4.place(relx=0.01, rely=0.56, relwidth=0.98, relheight=0.15)

test_archiving5=LabelFrame(archiving_note, text="노바 & 레프")
test_archiving5.place(relx=0.01, rely=0.71, relwidth=0.98, relheight=0.15)

test_archiving6=LabelFrame(archiving_note, text="아니마 & 제로 & 키네시스 ")
test_archiving6.place(relx=0.01, rely=0.86, relwidth=0.98, relheight=0.14)
...
test_mob1_ID4=tkinter.Button(test_guide1, justify="left", text="2435744   무형 보따리", relief="groove", borderwidth=0, command=copy_mob1_4)
...
test_c_setting4=tkinter.Button(test_skill1, justify="left", text="/runecreate 6\t\t\t\t\t           초월의 룬 소환",relief="groove",borderwidth=0, command=copy_c4)
